...
int handleMinion(struct gameState *state, int choice1, int choice2, int currentPlayer, int handPos)
{
    int i;
    int j;
...
int handleAmbassador(struct gameState *state, int choice1, int choice2, int currentPlayer, int handPos)
{
...
int handleTribute(struct gameState *state, int nextPlayer, int currentPlayer, int* tributeRevealedCards)
{
    int i;
...
int handleMine(struct gameState *state, int choice1, int choice2, int currentPlayer, int handPos)
{
    int i;
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
    ...
    case mine:
        handleMine(state, choice1, choice2, currentPlayer, handPos);
    ...
    case baron:
        handleBaron(state, choice1, currentPlayer);
    ...
    case minion:
        handleMinion(state, choice1, choice2, currentPlayer, handPos);
    ...
    case tribute:
        handleTribute(state, nextPlayer, currentPlayer, tributeRevealedCards);

    case ambassador:
        handleAmbassador(state, choice1, choice2, currentPlayer, handPos);
